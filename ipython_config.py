...
# The name of a Pygments style to use for syntax highlighting:  perldoc, igor,
# manni, monokai, colorful, pastie, algol_nu, murphy, xcode, fruity, borland,
# paraiso-dark, lovelace, trac, vs, paraiso-light, default, friendly, rrt,
# autumn, vim, bw, emacs, tango, native, algol
